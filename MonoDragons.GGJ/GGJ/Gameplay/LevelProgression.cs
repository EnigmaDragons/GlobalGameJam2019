    ...
    public sealed class LevelProgression
    {
        ...
        private void SetupCharacters(int level)
        {
            _data.InitLevel(level, 
                new CharacterState(Player.Cowboy, level == 1 ? 99 : _data.CowboyState.HP,
                ...
                new CharacterState(Player.House, 20 + level * 20, new PlayerCardsState(Enemies.CreateEnemyDeck(_data, _enemyOrder[level - 1]))));
